...
Para agregar una pregunta nueva, copiar un objeto existente, cambiar `id`, `question`, `country`, `answer`, `options` y `image`.
...
Se puede borrar manualmente desde la consola del navegador:
