...
export default function QuestionCard({ question, selected, setSelected, onAnswer, writingValue, setWritingValue, timeLeft }) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-6">
        ...
        <div className="min-w-32 border-2 border-lime bg-lime px-6 py-4 text-center font-display text-4xl text-night shadow-neon">
          {timeLeft}s
        </div>
      </div>
